...
/**
 * This class represents a Location (in pixels) on the screen and adds some
 * utility functions to the Point2D class.
 * 
 * Note, this might be overkill, it was just annoying that Point2D did not
 * implement translate :(
 * 
...
public class Location extends Point2D.Double {
	...
	/**
	 * Returns a vector that is the difference between this location and the
