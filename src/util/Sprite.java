...
public abstract class Sprite {
	...
	/**
	 * Create a shape at the given position, with the given size, velocity, and
	 * color.
	 */
	...
	protected void resetBounds() {
		myBounds = new Rectangle((int) getLeft(), (int) getTop(), mySize.width,
				mySize.height);
	}

	/**
	 * Returns approximate direction from center of rectangle to side which was
	 * hit or NaN if no hit took place.
	 */
